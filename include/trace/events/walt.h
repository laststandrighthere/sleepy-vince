...
TRACE_EVENT(sched_load_to_gov,
	...
	TP_printk("cpu=%d policy=%d ed_task_pid=%d aggr_grp_load=%llu freq_aggr=%llu tt_load=%llu rq_ps=%llu grp_rq_ps=%llu nt_ps=%llu grp_nt_ps=%llu pl=%llu load=%llu sysctl_sched_little_cluster_coloc_fmin_khz=%u coloc_boost_load=%llu",
